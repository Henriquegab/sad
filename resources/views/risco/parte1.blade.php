        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h3>Algoritmo SAD</h3>
                    <br>
                    <form method="post" action="{{route('incerteza.parte2')}}" autocomplete="off">
                        @csrf
                        <div class="form-group">
                            <label>Número de Cenários:</label>
                            <input type="number" class="form-control" name="variavel" required>
                            {{$errors->has('variavel') ? $errors->first('variavel') : ''}}
                        </div>
                        <div class="form-group">
                            <label>Numero de investimentos:</label>
                            <input type="number" class="form-control" name="restricao" required>
